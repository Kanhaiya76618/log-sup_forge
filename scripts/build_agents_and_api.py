...
Pydantic Request/Response validation schemas for FlowForge API.
"""
...
with open('backend/flowforge/contracts/schemas.py', 'w') as f:
...
class FlowForgePipelineOrchestrator:
    ...
    def run_pipeline(
        ...
        agent_steps.append({
            "step": "01",
            "name": "Live Signal Ingestion Agent",
        ...
        auto_approved = total_exposure_usd < 150000.0  # Threshold limit check
        dispatch_text = (
...
with open('backend/flowforge/agents/orchestrator.py', 'w') as f:
    f.write(orchestrator_code)

print('Schemas and Orchestrator written.')
